...
-- En este espacio es donde empezarias con tus toggles, buttons, etc




-- Seccion de los settings (no la toques, solo cambia el nombre del juego)
...
SaveManager:SetFolder("Moon Hub/specific-game") -- Cambia por el nombre del juego real
SaveManager:SetSubFolder("specific-place") -- Cambia por el nombre del juego real
